/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 74c6df5277eeee4ecdd587c8951f7e8e)
// Runtime types generated with workerd@1.20260601.1 2026-06-03 nodejs_compat
interface __BaseEnv_Env {
	DISCORD_APPLICATION_ID: "1511586869362561205";
	DISCORD_PUBLIC_KEY: "99813bf093616aa8ef97d144312eef8834c34fb9848a9e48095ea5e4ecf63bf5";
	PIXEL_CANVAS: DurableObjectNamespace<import("./src/index").PixelCanvas>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PixelCanvas";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_APPLICATION_ID" | "DISCORD_PUBLIC_KEY">> {}
}
